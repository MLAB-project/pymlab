...
class Bus(SimpleBus):
    ...
    def read_int16(self, address, register):            ## Must be checked, possible bug in byte manipulation (LTS01A sensor sometimes returns wrong values)
...
#        LOGGER.debug("Reading word %s from bus address %s",  hex(data), hex(address))
