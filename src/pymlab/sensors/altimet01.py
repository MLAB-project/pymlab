...
def ALTIMET01(Device):
	...
	def __init__(self, parent = None, address = 0x60, **kwargs):
		...
		self.MPL3115_OFFSET_H            =0x2d
	    	...
	    	# Set to Barometer  
		self.bus.write_byte_data(self.address, MPL3115_CTRL_REG1, "0xB8");
	    	# Enable Data Flags in PT_DATA_CFG
	    	self.bus.write_byte_data(self.address, MPL3115_PT_DATA_CFG, "0x07")
	    	# Set Active, barometer mode with an OSR = 128
	    	self.bus.write_byte_data(self.address, MPL3115_CTRL_REG1, "0x39")
